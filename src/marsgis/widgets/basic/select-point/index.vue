<template>
  <mars-dialog :handles="false" :min-width="340" height="330" right="10" title="坐标拾取" top="50" width="298">
    <template #icon>
      <local-i size="18" theme="outline"/>
    </template>
      ...
      <a-form>
        <a-form-item label="类型">
          <a-radio-group v-model:value="formState.radioFanwei" @change="changeFanwei">
            ...
            <a-radio title="2000平面坐标" value="3">平面坐标</a-radio>
          </a-radio-group>
        </a-form-item>
        ...
        <div v-show="formState.radioFanwei === '2'">
          <a-form-item label="经度">
            <a-space>
              <mars-input v-model:value="formState.jdDegree"></mars-input>
              °
              <mars-input v-model:value="formState.jdMinute"></mars-input>
              '
          ...
          <a-form-item label="纬度">
            <a-space>
              <mars-input v-model:value="formState.wdDegree"></mars-input>
              °
              <mars-input v-model:value="formState.wdMinute"></mars-input>
              '
